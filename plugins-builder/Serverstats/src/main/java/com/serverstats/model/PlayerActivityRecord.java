...
public final class PlayerActivityRecord {
    ...
    public static PlayerActivityRecord join(UUID playerId, String playerName, Location location, Instant timestamp) {
        return new PlayerActivityRecord(playerId, playerName, "JOIN", "server", location, null, 1, null, timestamp);
    }

    public static PlayerActivityRecord quit(UUID playerId, String playerName, Location location, Instant timestamp) {
        return new PlayerActivityRecord(playerId, playerName, "QUIT", "server", location, null, 1, null, timestamp);
    }
