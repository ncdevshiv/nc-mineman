        ...
        <div className="bg-zinc-950 border border-zinc-800 rounded-2xl p-6">
          ...
          <div className="flex gap-4 items-end">
            ...
            <button
              ...
              className="bg-indigo-600 hover:bg-indigo-500 text-white px-5 py-2 rounded-xl font-medium flex items-center gap-2 transition-colors"
            >
              <Loader2 size={18} className="animate-spin" />
              Creating...
            </button>
            <button
              onClick={() => { setCreating(false); setBackupName(''); }}
