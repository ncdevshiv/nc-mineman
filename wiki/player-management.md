...
2. **SQLite Database** — Persistent records with IP history, sessions, playtime, notes
...
Every RCON action (op, ban, whitelist, kick) is also persisted to the database automatically.

## Database Player Tracking
